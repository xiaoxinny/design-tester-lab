...
| 07 | `07-synthesis-architecture-proposal.md` | Synthesis; the implementation in `src/` and the deployment guide in [`../operations/deployment.md`](../operations/deployment.md) supersede this proposal | 35KB |
| 08 | `08-adversarial-review-v1.md` | Adversarial review of the initial synthesis | 30KB |
| 09 | `09-adversarial-review-v2.md` | Web-verified adversarial review — refuted 5 load-bearing claims, surfaced 3 concrete bugs, proposed a falsification experiment | 26KB |
...
5. `09-adversarial-review-v2.md` — the design decisions that shaped the approach
