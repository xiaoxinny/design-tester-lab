...
| Rate limiter: token bucket semantics | `pnpm test:rate-limit` | ✅ 14 cases pass (capacity, refill, isolation between keys, isolation between routes, retryAfterMs) |
